// TMDB API 로 넘어온 검색결과들을 담는 객체 List<MovieItem>
...
namespace ex10_MovieFinder2024.Models
{
    public class MovieItem
    {
        ...
        public string Overview {  get; set; } // 영화 소개
        
        public double Popularity { get; set; } // 인기도
        ...
        public DateTime? Reg_Data {  get; set; }    // 최초에는 없기 때문에 Nullable 지정
