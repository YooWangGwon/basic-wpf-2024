...
namespace ex11_Gimhae_FineDust.Models
{
    public class DustSensor
    {
        /*{
          ...
          "pm25_after": 69,
          "state": 0,
          "timestamp": "2024-04-24 14:57:04.084",
        ...
        public bool Ison { get; set; } // 디바이스 온오프 여부

        public double Pm10_after { get; set; } // PM 10mm 미세먼지 측정값

        public double Pm25_after { get; set; } // PM 2.5mm 초미세먼지 측정값
        ...
        public static readonly string DELETE_QUERY = @"";
    }
}
